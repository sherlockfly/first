...
public class ExpertGoods {
	 private Long id;
	    ...
	    private String subhead; //推荐理由  一句话总结 前段黑字显示
	    
	    private String content;  //商品推荐详细
		...
		public String getUpdtor() {
			return updtor;
		}

		public void setUpdtor(String updtor) {
			this.updtor = updtor;
		}
	    ...
	    public void setTinyUrl(String tinyUrl) {
	        this.tinyUrl = tinyUrl == null ? null : tinyUrl.trim();
	    }
	    ...
	    public void setDiscountUrl(String discountUrl) {
	        this.discountUrl = discountUrl == null ? null : discountUrl.trim();
	    }
